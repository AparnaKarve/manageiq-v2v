...
export const YES_AND_HIDE_DELETE_CONFIRMATION_MODAL = 'YES_AND_HIDE_DELETE_CONFIRMATION_MODAL';
export const MAPPING_TO_BE_DELETED = 'MAPPING_TO_BE_DELETED';
export const DELETE_INFRA_MAPPING = 'DELETE_INFRA_MAPPING';
